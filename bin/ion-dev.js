  ...
  start: function() {
    ...
    document.addEventListener("DOMContentLoaded", function() {
      ...
      if (diagnosticsEle) {
        ...
        var customIcon = document.querySelector('link[rel*="icon"]').href;
        if (customIcon) {
          this.activeIcon = customIcon;
        } else {
          this.activeIcon = this.defaultActiveIcon;
        }
